...
export const MODULE_PERMISSIONS = [
  ...
  { key: "schedule", label: "Classes & Schedule" },
  { key: "calendar", label: "Calendar", actions: ["view", "create", "edit"] },
...
export const DEFAULT_CATEGORY_PERMISSIONS = {
  ...
  "category:staff:trainer": buildPermissions(
    ["dashboard", "members", "schedule", "calendar", "attendance", "subscriptions", "classes", "workouts", "nutrition", "communication"],
    {
      members: ["read"],
  ...
  "category:staff:receptionist": buildPermissions(
    ["dashboard", "members", "plans", "payments", "schedule", "calendar", "attendance", "subscriptions", "classes", "communication", "reminders"],
    {
